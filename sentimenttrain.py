...
short_pos = open("text_files/positive.txt","r").read()
short_neg = open("text_files/negative.txt","r").read()
...
save_featuresets = open("algos/featuresets.pickle", "wb")
...
save_classifier = open("algos/NuSVC_classifier5k.pickle","wb")
